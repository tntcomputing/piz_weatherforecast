# Module: Weather Forecast - Pi Zero compatible
The `piz_weatherforecast` module has been modified from the default 'weatherforecast' module included in MagicMirror. The original module contained several es6 features that are not supported within Midori, this version of the module has had es6 features rewritten for compatibility with Midori. Midori is normally used within the PiZero and Pi1 MagicMirror setups.
